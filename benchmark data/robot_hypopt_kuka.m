...
%% data pre-processing
load('forward_identification_without_raw_data.mat')
Xall            = [u_train';u_test'];
...
writematrix(X,'X_kuka.csv')
writematrix(y,'y_kuka.csv')
writematrix(Xtest,'Xtest_kuka.csv')
writematrix(ytest,'ytest_kuka.csv')
